...
export function GoalPlan({ state, dispatch, onComplete }: StepProps) {
  const [name, setName] = useState('');
  const [reviewPeriodId, setReviewPeriodId] = useState<string | undefined>();
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Define a goal container and link it to a review period.</CardDescription>
        </CardHeader>
